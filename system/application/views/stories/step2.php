...
<title><?= $this->config->item('title') ?> - Share a story</title>
</head>
<body>
	...
	<div id="maincol">
        <div id="media" class="clearfix">
            ...
            <div id="preview-info">
            	...
            	<input name="headline" value="<?= set_value('headline', $headline) ?>"/>
                <?= form_error('headline') ?>
                <label>Brief Description</label>
                <textarea name="what"><?= set_value('what', $article) ?></textarea>
                <?= form_error('what') ?>
            </div>
        </div>
        <div id="tags">
